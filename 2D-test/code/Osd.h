...
static const  int   default_osd_format_to_ge2d_format[]={
	0, 
	0,
...
//	char	*osdfbp;
	...
	int	(*fill_rect)(struct OSD_OBJ_T *this_osd, rectangle_t this_rect, unsigned long color);
	int	(*blit)(struct OSD_OBJ_T *dst, rectangle_t dst_rect, struct OSD_OBJ_T *src,  rectangle_t src_rect);
	int	(*stretch_blit)(struct OSD_OBJ_T *dst, rectangle_t dst_rect, struct OSD_OBJ_T *src,  rectangle_t src_rect);
	int	(*blend)(struct OSD_OBJ_T *dst, rectangle_t dst_rect, struct OSD_OBJ_T *src,  rectangle_t src_rect, struct OSD_OBJ_T *src2,  rectangle_t src2_rect);
	void  *para;
	ge2d_src_canvas_type type;		
	UINT32 pixelformat;
	int nWidth;
	int nHeight;
//	int nBeginWidth;
//	int nBeginHeight;
	config_planes_t planes[4];
}osd_obj_t;

/*
struct _GE2D_OP_FUNC_T{
	int	(*fill_rect)(struct OSD_OBJ_T *this_osd, rectangle_t this_rect, unsigned long color);
	int	(*blit)(struct OSD_OBJ_T *dst, rectangle_t dst_rect, struct OSD_OBJ_T *src,  rectangle_t src_rect);
	int	(*stretch_blit)(struct OSD_OBJ_T *dst, rectangle_t dst_rect, struct OSD_OBJ_T *src,  rectangle_t src_rect);
	int	(*blend)(struct OSD_OBJ_T *dst, rectangle_t dst_rect, struct OSD_OBJ_T *src,  rectangle_t src_rect, struct OSD_OBJ_T *src2,  rectangle_t src2_rect);
